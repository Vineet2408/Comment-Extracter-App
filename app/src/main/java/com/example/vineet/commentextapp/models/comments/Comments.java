package com.example.vineet.commentextapp.models.comments;
...
public class Comments
{
    ...
    public class Comment {
        ...
        public Snippet__ getSnippet() {
            return snippet;
        }

        public void setSnippet(Snippet__ snippet) {
    ...
    public class Snippet__ {
        ...
        @SerializedName("authorChannelId")
        @Expose
        private AuthorChannelId_ authorChannelId;
        @SerializedName("videoId")
        @Expose
        private String videoId;
        @SerializedName("textDisplay")
        ...
        public AuthorChannelId_ getAuthorChannelId() {
            return authorChannelId;
        }

        public void setAuthorChannelId(AuthorChannelId_ authorChannelId) {
            this.authorChannelId = authorChannelId;
        }
